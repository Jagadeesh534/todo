                    ...
                    >
                      <span className="mr-1">
                        <svg
                          ...
                          height="18"
                          fill="currentColor"
                          className={`bi bi-flag-fill ${obj.priority === 1 ? ' text-danger': ''}  ${obj.priority === 2 ? ' text-warning': ''}  ${obj.priority === 3 ? ' text-info': ''}` }
                          viewBox="0 0 16 16"
                        >
                ...
                <div className="text-center d-flex justify-content-between align-items-center p-1">
                  <p className="audit-text">
                    ...
                    {obj?.dueDate && (
                      <span
                        className={`${
                          dayjs(obj.dueDate, "DD-MM-YYYY hh:mm:ss a")?.isBefore(
                            currentDate
                          ) && obj.done === false
                            ? "blink-text"
                            : ""
